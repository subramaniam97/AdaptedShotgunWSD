...
class ShotgunWSD {
    ...
    @Parameter(names = "-thres", description = "Threshold to decide resolution", required = true)
    private double thres;
    
    @Parameter(names = "-ws", description = "Window Length for final conversion", required = true)
    private Integer ws;
    ...
    public void run() {
        ...
        //documents contains words to disambiguate
        ...
        for(ParsedDocument document : documents) {
            ShotgunWSDRunner wsdRunner = new ShotgunWSDRunner(document, n, c, k, minSynsetCollisions, maxSynsetCollisions, synsetRelatedness, thres, ws);
